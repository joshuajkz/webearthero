    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload($field_name)) {
                $data = array(
                    'title' => 'Add Produk',
                    'kategori' => $this->m_kategori->get_all_data(), 'error_upload' => $this->upload->display_errors(),
                    'isi' => 'produk/v_add',
                );
                $this->load->view('layout/v_wrapper_backend', $data, FALSE);
            } else {
    ...
    public function edit($id_produk = NULL)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload($field_name)) {
                $data = array(
                    'title' => 'Edit Produk',
                    'kategori' => $this->m_kategori->get_all_data(), 'produk' => $this->m_produk->get_data($id_produk),
