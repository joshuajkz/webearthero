        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Berat (g)</label>
                        <input type="number" min="0" name="berat" class="form-control" placeholder="Berat Produk" value="<?= set_value('berat') ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <a href="<?= base_url('produk') ?>" class="btn btn-default btn-sm">Kembali</a>
